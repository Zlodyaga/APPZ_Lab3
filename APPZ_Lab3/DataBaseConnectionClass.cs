    ...
    public static class DataBaseConnectionClass
    {
        ...
        public static List<IUser> GetUsersAll()
        {
            ...
            while (reader.Read())
            {
                ...
                {
                    case "admin":
                        users.Add(new Admin(id, username, lastName, firstName, email, phone, sex));
                        break;
                    case "teacher":
                        users.Add(new Teacher(id, username, lastName, firstName, email, phone, sex));
                        break;
                    case "student":
                        users.Add(new Student(id, username, lastName, firstName, email, phone, sex));
                        break;
                    default:
                        break;
                }
